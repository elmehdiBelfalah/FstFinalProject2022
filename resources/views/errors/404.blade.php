@include('template.header')
 <div class="container py-5 mb-lg-3">
        <div class="row justify-content-center pt-lg-4 text-center">
          <div class="col-lg-5 col-md-7 col-sm-9"><img class="d-block mx-auto mb-5" src="{{url('img/pages/404.png')}}" width="340" alt="404 Error">
        ...
        <div class="row justify-content-center">
          <div class="col-xl-8 col-lg-10">
            <div class="row">
              ...
              <div class="col-sm-6 mb-3"><a class="card h-100 border-0 shadow-sm" href="{{url('shop')}}">
                  <div class="card-body">
                    <div class="d-flex align-items-center"><i class="ci-cart text-success h4 mb-0"></i>
                      <div class="ps-3">
                        <h5 class="fs-sm mb-0">Shop</h5><span class="text-muted fs-ms">Shop & find products</span>
                      </div>
                    </div>
                  </div></a></div>
