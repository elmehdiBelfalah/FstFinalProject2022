        ...
        <div class="px-lg-3">
            <div class="row">
                    ...
                    <div class="product-gallery">
                        <div class="product-gallery-preview order-sm-2">
                            <div class="product-gallery-preview-item active" id="first"><img class="image-zoom"
                                    src="{{ asset('img/shop/catalog/' . $product->id . '.jpg') }}"
                                    data-zoom="{{ asset('img/shop/catalog/' . $product->id . '.jpg') }}"
                                    alt="Product image">
                                <div class="image-zoom-pane"></div>
                            </div>
                            {{-- <div class="product-gallery-preview-item" id="second"><img class="image-zoom" src="{{asset('img/shop/catalog/'.$product->id.'.jpg')}}" data-zoom="{{asset('img/shop/catalog/'.$product->id.'.jpg')}}" alt="Product image">
                  <div class="image-zoom-pane"></div>
                </div>
                <div class="product-gallery-preview-item" id="third"><img class="image-zoom" src="{{asset('img/shop/catalog/'.$product->id.'.jpg')}}" data-zoom="{{asset('img/shop/catalog/'.$product->id.'.jpg')}}" alt="Product image">
                  <div class="image-zoom-pane"></div>
                </div>
                <div class="product-gallery-preview-item" id="fourth"><img class="image-zoom" src="{{asset('img/shop/catalog/'.$product->id.'.jpg')}}" data-zoom="{{asset('img/shop/catalog/'.$product->id.'.jpg')}}" alt="Product image">
                  <div class="image-zoom-pane"></div>
                </div> --}}
                        </div>
                        <div class="product-gallery-thumblist order-sm-1">
                            <a class="product-gallery-thumblist-item active" href="#first"><img
                                    src="{{ asset('img/shop/catalog/' . $product->id . '.jpg') }}"
                                    alt="Product thumb"></a>
                            {{-- <a class="product-gallery-thumkblist-item" href="#second"><img src="{{asset('img/shop/catalog/'.$product->id.'.jpg')}}" alt="Product thumb"></a> --}}
                            {{-- <a class="product-gallery-thumblist-item" href="#third"><img src="img/shop/single/gallery/th03.jpg" alt="Product thumb"></a> --}}
                            {{-- <a class="product-gallery-thumblist-item" href="#fourth"><img src="img/shop/single/gallery/th04.jpg" alt="Product thumb"></a><a class="product-gallery-thumblist-item video-item" href="https://www.youtube.com/watch?v=1vrXpMLLK14"> --}}
                    ...
                    <div class="product-details ms-auto pb-3">
                        <div class="d-flex justify-content-between align-items-center mb-2"><a href="#reviews"
                                ...
                                <div class="star-rating">
                                    ...
                                    class="d-inline-block fs-sm text-body align-middle mt-1 ms-1">{{ $product->reviews }}
                                    Reviews</span>
                            </a>
                        ...
                        <div class="mb-3"><span class="h3 fw-normal text-accent me-1">{{floor($product->price)}}<small>.99 MAD</small> </span>
                            <del class="text-muted fs-lg me-3">{{floor($product->price + rand(1 , 35))}}<small>.00 MAD</small></del><span
                ...
                <div class="product-badge product-available mt-n1"><i class="ci-security-check"></i>Product available</div>
                        ...
                        <form class="mb-grid-gutter" method="post" action="{{ url('/cart/add') }}">
                         ...
                         {{ csrf_field() }}
                            ...
                            <div class="mb-3 d-flex align-items-center">
                                <select name="qty" class="form-select me-3" style="width: 5rem;">
    ...
    <div class="container pt-md-2" id="reviews">
        <div class="row pb-3">
            <div class="col-lg-4 col-md-5">
                ...
                <h2 class="h3 mb-4">{{ $product->reviews }} Reviews</h2>
            ...
            <div class="col-lg-8 col-md-7">
                <div class="d-flex align-items-center mb-2">
                    ...
                    </div><span class="text-muted ms-3">{{$product->reviews - ($product->reviews - rand(400 , 200))}}</span>
                </div>
                <div class="d-flex align-items-center mb-2">
                    ...
                    <div class="w-100">
                        <div class="progress" style="height: 4px;">
                            <div class="progress-bar" role="progressbar" style="width: {{rand(10  , 100)}}%; background-color: #a7e453;"
                ...
                <div class="d-flex align-items-center mb-2">
                    ...
                    <div class="w-100">
                        <div class="progress" style="height: 4px;">
                            <div class="progress-bar" role="progressbar" style="width: {{rand(10  , 100)}}%; background-color: #ffda75;"
                ...
                <div class="d-flex align-items-center mb-2">
                    ...
                    <div class="w-100">
                        <div class="progress" style="height: 4px;">
                            <div class="progress-bar" role="progressbar" style="width: {{rand(10  , 100)}}%; background-color: #fea569;"
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="w-100">
                        <div class="progress" style="height: 4px;">
                            <div class="progress-bar bg-danger" role="progressbar" style="width: {{rand(10  , 100)}}%;" aria-valuenow="4"
            ...
            <div>
                <div class="card product-card card-static">
                    <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left"
                        ...
                        class="card-img-top d-block overflow-hidden" href="{{url('products/'.$product->id)}}"><img src="{{asset('img/shop/catalog/'.$product->id.'.jpg')}}"
                            alt="Product"></a>
                    <div class="card-body py-2"><a class="product-meta d-block fs-xs pb-1" href="#">Men’s Jeans</a>
                        <h3 class="product-title fs-sm"><a href="{{url('products/'.$product->id)}}">Slim Taper Fit Jeans</a></h3>
                        <div class="d-flex justify-content-between">
                            <div class="product-price"><span class="text-accent">{{floor($product->price)}}.<small>99</small></span></div>
                            <div class="star-rating">
                                @for ($i = 0; $i < $product->rate; $i++)
                                <i class="star-rating-icon ci-star-filled active"></i>
                                @endfor
