            ...
            <div class="row pb-2">
                <div class="col-md-6 text-center text-md-start mb-4">
                    <div class="text-nowrap mb-4"><a class="d-inline-block align-middle mt-n1 me-3" href="#">
                            {{-- <img
                                class="d-block" src="img/footer-logo-light.png" width="117" alt="Cartzilla"> --}}
                        </a>
                        {{-- <div class="btn-group dropdown disable-autohide">
                            <button class="btn btn-outline-light border-light btn-sm dropdown-toggle px-2" type="button"
                                data-bs-toggle="dropdown"><img class="me-2" src="{{ asset('img/flags/en.png') }}"
...
@endif
@if (Session::has('shouldRegister'))
    <script>
        document.getElementById('openLogin').click();

           document.getElementById('signupActivator').click();
