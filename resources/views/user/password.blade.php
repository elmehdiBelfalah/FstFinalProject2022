      ...
      <aside class="col-lg-4 pt-4 pt-lg-0 pe-xl-5">
        <div class="bg-white rounded-3 shadow-lg pt-1 mb-5 mb-lg-0">
          ...
          <div class="d-lg-block collapse" id="account-menu">
            ...
            <ul class="list-unstyled mb-0">
              <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 " href="{{url('users/'.$user->id)}}"><i class="ci-user opacity-60 me-2"></i>Profile info</a></li>
              <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 active" href="{{url('users/password/'.$user->id)}}"><i class="ci-locked opacity-60 me-2"></i>Password</a></li>
          ...
          <div class="row gx-4 gy-3">
            ...
            <div class="col-sm-6">
              ...
              <div class="password-toggle">
                <input class="form-control" name="password" required  type="password" id="account-pass">
            ...
            <div class="col-sm-6">
              ...
              <div class="password-toggle">
                <input class="form-control" required name="password_confirmation"  type="password" id="account-confirm-pass">
                <label class="password-toggle-btn" aria-label="Show/hide password">
                  <input class="password-toggle-check"   type="checkbox"><span class="password-toggle-indicator"></span>
                </label>
              </div>
